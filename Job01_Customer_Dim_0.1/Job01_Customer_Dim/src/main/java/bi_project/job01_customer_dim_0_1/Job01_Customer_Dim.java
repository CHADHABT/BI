...
package bi_project.job01_customer_dim_0_1;
...
public static class customer_dimStruct implements routines.system.IPersistableRow<customer_dimStruct> {
    final static byte[] commonByteArrayLock_BI_PROJECT_Job01_Customer_Dim = new byte[0];
    static byte[] commonByteArray_BI_PROJECT_Job01_Customer_Dim = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_BI_PROJECT_Job01_Customer_Dim.length) {
				if(length < 1024 && commonByteArray_BI_PROJECT_Job01_Customer_Dim.length == 0) {
   					commonByteArray_BI_PROJECT_Job01_Customer_Dim = new byte[1024];
				} else {
   					commonByteArray_BI_PROJECT_Job01_Customer_Dim = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_BI_PROJECT_Job01_Customer_Dim, 0, length);
			strReturn = new String(commonByteArray_BI_PROJECT_Job01_Customer_Dim, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_BI_PROJECT_Job01_Customer_Dim, 0, length);
			strReturn = new String(commonByteArray_BI_PROJECT_Job01_Customer_Dim, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_BI_PROJECT_Job01_Customer_Dim) {
...
customer_dimStruct customer_dim = new customer_dimStruct();
	...
	final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:tWVxg46qaqEyBVw8jyKORhYNAgf+amozTAWGfPVYaTjdJ7UMDYwXj2g=");
        ...
        if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
            ...
            tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "." + ("CUSTOMER_DIM");
                ...
                String insert_tDBOutput_1 = "INSERT INTO " + tableName_tDBOutput_1 + " (CUSTOMER_ID,CUSTOMER_COUNTRY,CUSTOMER_GROUP,CUSTOMER_TYPE,CUSTOMER_GENDER,CUSTOMER_AGE_GROUP,CUSTOMER_AGE,CUSTOMER_NAME,CUSTOMER_FIRSTNAME,CUSTOMER_LASTNAME,CUSTOMER_BIRTH_DATE) VALUES (?,?,?,?,?,?,?,?,?,?,?)";    
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:YZcaaN+F8mdZyDcqOPHlKZEbtkP7lsTDWjX+yw==");
...
} else {if(customer_dim.CUSTOMER_AGE_GROUP == null) {
pstmt_tDBOutput_1.setNull(6, java.sql.Types.CHAR);
} else if(customer_dim.CUSTOMER_AGE_GROUP == " "){
pstmt_tDBOutput_1.setString(6, "");
} else {
pstmt_tDBOutput_1.setString(6, String.valueOf(customer_dim.CUSTOMER_AGE_GROUP));
}}
...
} else {if(customer_dim.CUSTOMER_NAME == null) {
pstmt_tDBOutput_1.setNull(8, java.sql.Types.CHAR);
} else if(customer_dim.CUSTOMER_NAME == " "){
pstmt_tDBOutput_1.setString(8, "");
} else {
pstmt_tDBOutput_1.setString(8, String.valueOf(customer_dim.CUSTOMER_NAME));
}}

                        if(customer_dim.CUSTOMER_FIRSTNAME == null) {
pstmt_tDBOutput_1.setNull(9, java.sql.Types.VARCHAR);
} else {if(customer_dim.CUSTOMER_FIRSTNAME == null) {
pstmt_tDBOutput_1.setNull(9, java.sql.Types.CHAR);
} else if(customer_dim.CUSTOMER_FIRSTNAME == " "){
pstmt_tDBOutput_1.setString(9, "");
} else {
pstmt_tDBOutput_1.setString(9, String.valueOf(customer_dim.CUSTOMER_FIRSTNAME));
}}

                        if(customer_dim.CUSTOMER_LASTNAME == null) {
pstmt_tDBOutput_1.setNull(10, java.sql.Types.VARCHAR);
} else {if(customer_dim.CUSTOMER_LASTNAME == null) {
pstmt_tDBOutput_1.setNull(10, java.sql.Types.CHAR);
} else if(customer_dim.CUSTOMER_LASTNAME == " "){
pstmt_tDBOutput_1.setString(10, "");
} else {
pstmt_tDBOutput_1.setString(10, String.valueOf(customer_dim.CUSTOMER_LASTNAME));
}}

                        if(customer_dim.CUSTOMER_BIRTH_DATE != null) {
pstmt_tDBOutput_1.setObject(11, new java.sql.Timestamp(customer_dim.CUSTOMER_BIRTH_DATE.getTime()),java.sql.Types.DATE);
} else {
 ...
 */
	...
	final String decryptedPassword_tDBInput_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:xXkmAfEn4/9mYiJR586ku4HJ36kn30SWccci7Q==");
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Job01_Customer_Dim.class.getClassLoader().getResourceAsStream("bi_project/job01_customer_dim_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     115858 characters generated by Talend Open Studio for Data Integration 
 *     on the April 15, 2023 at 12:04:43 AM CET
 ************************************************************************************************/