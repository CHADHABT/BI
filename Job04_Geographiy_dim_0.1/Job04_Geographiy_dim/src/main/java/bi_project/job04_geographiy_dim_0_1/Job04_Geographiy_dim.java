...
package bi_project.job04_geographiy_dim_0_1;
...
/**
 * Job: Job04_Geographiy_dim Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class Job04_Geographiy_dim implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "Job04_Geographiy_dim";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Job04_Geographiy_dim.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Job04_Geographiy_dim.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class geography_dimStruct implements routines.system.IPersistableRow<geography_dimStruct> {
    final static byte[] commonByteArrayLock_BI_PROJECT_Job04_Geographiy_dim = new byte[0];
    static byte[] commonByteArray_BI_PROJECT_Job04_Geographiy_dim = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_BI_PROJECT_Job04_Geographiy_dim.length) {
				if(length < 1024 && commonByteArray_BI_PROJECT_Job04_Geographiy_dim.length == 0) {
   					commonByteArray_BI_PROJECT_Job04_Geographiy_dim = new byte[1024];
				} else {
   					commonByteArray_BI_PROJECT_Job04_Geographiy_dim = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_BI_PROJECT_Job04_Geographiy_dim, 0, length);
			strReturn = new String(commonByteArray_BI_PROJECT_Job04_Geographiy_dim, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_BI_PROJECT_Job04_Geographiy_dim, 0, length);
			strReturn = new String(commonByteArray_BI_PROJECT_Job04_Geographiy_dim, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_BI_PROJECT_Job04_Geographiy_dim) {
...
geography_dimStruct geography_dim = new geography_dimStruct();
	...
	currentComponent="tDBOutput_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"geography_dim");
					}
	...
	final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:OntLk9vDow7kTm2BA7fkGqfXjl2G1+DlD5otQoW5BS20jd4gD0STzvo=");
        ...
        if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
            ...
            tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "." + ("GEOGRAPHY_DIM");
                ...
                String insert_tDBOutput_1 = "INSERT INTO " + tableName_tDBOutput_1 + " (STREET_ID,CONTINENT,COUNTRY,STATE_CODE,STATE,REGION,PROVINCE,COUNTY,CITY,POSTAL_CODE,STREET_NAME) VALUES (?,?,?,?,?,?,?,?,?,?,?)";    
...
stateStruct stateDefault = new stateStruct();
		...
		tHash_Lookup_continent.initGet();
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:2OkqmFsMmwPPSUK79j4QcSX3juevT+PtJzWNTg==");
 					    ...
 					    boolean forceLoopcounty = false;
 							...
 							countyStruct countyObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
                        		    		    ...
                        		    		    countyHashKey.COUNTRY = street.COUNTRY ;
				           		...
				           		if(tHash_Lookup_county != null && tHash_Lookup_county.getCount(countyHashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'county' and it contains more one result from keys :  county.COUNTRY = '" + countyHashKey.COUNTRY + "'");
								} // G 071
 					    ...
 					    boolean forceLoopcontinent = false;
 							...
 							continentStruct continentObjectFromLookup = null;
		           		  	...
		           		  	if(!rejectedInnerJoin_tMap_1) { // G_TM_M_020
								  ...
								  if(!tHash_Lookup_continent.hasNext()) { // G_TM_M_090
							...
							continentStruct continent = null;
								...
								while ((tHash_Lookup_continent != null && tHash_Lookup_continent.hasNext()) || forceLoopcontinent) { // G_TM_M_043

								
									 // CALL close loop of lookup 'continent'
 					    ...
 					    boolean forceLoopcountry = false;
 							...
 							countryStruct countryObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
                        		    		    ...
                        		    		    countryHashKey.COUNTRY_ID = continent.CONTINENT_ID ;
				           		...
				           		if(tHash_Lookup_country != null && tHash_Lookup_country.getCount(countryHashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'country' and it contains more one result from keys :  country.COUNTRY_ID = '" + countryHashKey.COUNTRY_ID + "'");
								} // G 071
...
geography_dim_tmp.STREET_ID = street.STREET_ID ;
geography_dim_tmp.CONTINENT = continent.CONTINENT_NAME ;
geography_dim_tmp.COUNTRY = street.COUNTRY ;
...
geography_dim_tmp.CITY = street.CITY_NAME ;
geography_dim_tmp.POSTAL_CODE = street.POSTAL_CODE ;
geography_dim_tmp.STREET_NAME = street.STREET_NAME ;
...
} else {if(geography_dim.COUNTRY == null) {
pstmt_tDBOutput_1.setNull(3, java.sql.Types.CHAR);
} else if(geography_dim.COUNTRY == " "){
pstmt_tDBOutput_1.setString(3, "");
} else {
pstmt_tDBOutput_1.setString(3, String.valueOf(geography_dim.COUNTRY));
}}

                        if(geography_dim.STATE_CODE == null) {
pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {if(geography_dim.STATE_CODE == null) {
pstmt_tDBOutput_1.setNull(4, java.sql.Types.CHAR);
} else if(geography_dim.STATE_CODE == " "){
pstmt_tDBOutput_1.setString(4, "");
} else {
pstmt_tDBOutput_1.setString(4, String.valueOf(geography_dim.STATE_CODE));
}}
...
} else {if(geography_dim.POSTAL_CODE == null) {
pstmt_tDBOutput_1.setNull(10, java.sql.Types.CHAR);
} else if(geography_dim.POSTAL_CODE == " "){
pstmt_tDBOutput_1.setString(10, "");
} else {
pstmt_tDBOutput_1.setString(10, String.valueOf(geography_dim.POSTAL_CODE));
}}
 ...
 */
		...
		} // close loop of lookup 'continent' // G_TM_M_043
...
globalMap.put("tDBOutput_1_ERROR_MESSAGE",e_tDBOutput_1.getMessage());
	...
	nb_line_rejected_tDBOutput_1=nb_line_rejected_tDBOutput_1 + rejectedCount_tDBOutput_1;
        ...
        globalMap.put("tDBOutput_1_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_1);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"geography_dim");
			  	}
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_county";
		...
		int tos_count_tAdvancedHash_county = 0;
			   		...
			   		// source node:tDBInput_3 - inputs:(after_tDBInput_1) outputs:(county,county) | target node:tAdvancedHash_county - inputs:(county) outputs:()
			   		// linked node: tMap_1 - inputs:(street,county,state,continent,country) outputs:(geography_dim)
 ...
 */
	...
	final String decryptedPassword_tDBInput_3 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:WQaotyskTVy3lEYVmwQo4MANZzSIF6m40FcX/Q==");
...
+"AME, \n  COUNTY.REGION_NAME, \n  COUNTY.REGION_TYPE, \n  COUNTY.STATE_ID, \n  COUNTY.COUNTRY\nFROM COUNTY";
            ...
            county.COUNTY_ID = rs_tDBInput_3.getDouble(1);
            ...
            county.COUNTY_TYPE = rs_tDBInput_3.getDouble(2);
            if(rs_tDBInput_3.wasNull()){
                    county.COUNTY_TYPE = null;
            }
		                    }
        	...
        	county.COUNTY_NAME = routines.system.JDBCUtil.getString(rs_tDBInput_3, 3, false);
		                    }
							if(colQtyInRs_tDBInput_3 < 4) {
								county.PROVINCE_TYPE = null;
							} else {
	                         		
            county.PROVINCE_TYPE = rs_tDBInput_3.getDouble(4);
            if(rs_tDBInput_3.wasNull()){
                    county.PROVINCE_TYPE = null;
            }
		                    }
        	...
        	county.PROVINCE_NAME = routines.system.JDBCUtil.getString(rs_tDBInput_3, 5, false);
		                    }
							if(colQtyInRs_tDBInput_3 < 6) {
								county.REGION_NAME = null;
							} else {
	                         		
        	county.REGION_NAME = routines.system.JDBCUtil.getString(rs_tDBInput_3, 6, false);
		                    }
							if(colQtyInRs_tDBInput_3 < 7) {
								county.REGION_TYPE = null;
							} else {
	                         		
            county.REGION_TYPE = rs_tDBInput_3.getDouble(7);
            if(rs_tDBInput_3.wasNull()){
                    county.REGION_TYPE = null;
            }
		                    }
            ...
            county.STATE_ID = rs_tDBInput_3.getDouble(8);
            if(rs_tDBInput_3.wasNull()){
                    county.STATE_ID = null;
            }
		                    }
        	...
        	county.COUNTRY = routines.system.JDBCUtil.getString(rs_tDBInput_3, 9, false);
		                    }
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_state";
		...
		int tos_count_tAdvancedHash_state = 0;
			   		...
			   		// source node:tDBInput_4 - inputs:(after_tDBInput_1) outputs:(state,state) | target node:tAdvancedHash_state - inputs:(state) outputs:()
			   		// linked node: tMap_1 - inputs:(street,county,state,continent,country) outputs:(geography_dim)
 ...
 */
	...
	final String decryptedPassword_tDBInput_4 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:pthRwqRzO0eHiJwlvfmyDHpcMXuh2Sn12vcdiw==");
            ...
            state.STATE_ID = rs_tDBInput_4.getDouble(1);
            ...
            state.STATE_TYPE = rs_tDBInput_4.getDouble(2);
            if(rs_tDBInput_4.wasNull()){
                    state.STATE_TYPE = null;
            }
		                    }
        	...
        	state.STATE_CODE = routines.system.JDBCUtil.getString(rs_tDBInput_4, 3, false);
		                    }
							if(colQtyInRs_tDBInput_4 < 4) {
								state.STATE_NAME = null;
							} else {
	                         		
        	state.STATE_NAME = routines.system.JDBCUtil.getString(rs_tDBInput_4, 4, false);
		                    }
							if(colQtyInRs_tDBInput_4 < 5) {
								state.COUNTRY = null;
							} else {
	                         		
        	state.COUNTRY = routines.system.JDBCUtil.getString(rs_tDBInput_4, 5, false);
		                    }
...
public static class continentStruct implements routines.system.IPersistableRow<continentStruct> {
    final static byte[] commonByteArrayLock_BI_PROJECT_Job04_Geographiy_dim = new byte[0];
    static byte[] commonByteArray_BI_PROJECT_Job04_Geographiy_dim = new byte[0];
 ...
 */
	...
	final String decryptedPassword_tDBInput_5 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:ZgJjxTbEVOQCLfMLZ6bEo9n0UcgMHae2sJ1kUA==");
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_country";
		...
		int tos_count_tAdvancedHash_country = 0;
			   		...
			   		// source node:tDBInput_2 - inputs:(after_tDBInput_1) outputs:(country,country) | target node:tAdvancedHash_country - inputs:(country) outputs:()
			   		// linked node: tMap_1 - inputs:(street,county,state,continent,country) outputs:(geography_dim)
 ...
 */
	...
	final String decryptedPassword_tDBInput_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:WR7iCEVGhAC1LK7YSb3OpXgi149jPg6no0Mqig==");
...
+"ID, \n  COUNTRY.COUNTRY_FORMERNAME\nFROM COUNTRY";
        	...
        	country.COUNTRY = routines.system.JDBCUtil.getString(rs_tDBInput_2, 1, false);
		                    }
							if(colQtyInRs_tDBInput_2 < 2) {
								country.COUNTRY_NAME = null;
							} else {
	                         		
        	country.COUNTRY_NAME = routines.system.JDBCUtil.getString(rs_tDBInput_2, 2, false);
		                    }
							if(colQtyInRs_tDBInput_2 < 3) {
								country.POPULATION = null;
							} else {
	                         		
            country.POPULATION = rs_tDBInput_2.getDouble(3);
            ...
            country.COUNTRY_ID = rs_tDBInput_2.getDouble(4);
            if(rs_tDBInput_2.wasNull()){
                    country.COUNTRY_ID = null;
            }
		                    }
            ...
            country.CONTINENT_ID = rs_tDBInput_2.getDouble(5);
            if(rs_tDBInput_2.wasNull()){
                    country.CONTINENT_ID = null;
            }
		                    }
        	...
        	country.COUNTRY_FORMERNAME = routines.system.JDBCUtil.getString(rs_tDBInput_2, 6, false);
		                    }
 ...
 */
    ...
    public static void main(String[] args){
        final Job04_Geographiy_dim Job04_Geographiy_dimClass = new Job04_Geographiy_dim();

        int exitCode = Job04_Geographiy_dimClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Job04_Geographiy_dim.class.getClassLoader().getResourceAsStream("bi_project/job04_geographiy_dim_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Job04_Geographiy_dim.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Job04_Geographiy_dim");
        }
...
/************************************************************************************************
 *     186971 characters generated by Talend Open Studio for Data Integration 
 *     on the April 15, 2023 at 12:05:34 AM CET
 ************************************************************************************************/