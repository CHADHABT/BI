...
package bi_project.job05_order_fact_0_1;
...
private class TalendException extends Exception {
	...
	public void printStackTrace() {
		...
		try {
			...
			public void tDBOutput_1_onSubJobError(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
...
public void tDBOutput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:Wbm0bIMG00fgQg+0QVH5HNmHtpb1bwsTs4uoq7J7h8ja74a/gA3E01Q=");
        ...
        if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
            tableName_tDBOutput_1 = ("ORDER_FACT");
        } else {
            tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "." + ("ORDER_FACT");
        }
                String insert_tDBOutput_1 = "INSERT INTO " + tableName_tDBOutput_1 + " (CUSTOMER_ID,EMPLOYEE_ID,STREET_ID,PRODUCT_ID,ORDER_DATE,ORDER_ID,ORDER_TYPE,DELIVERY_DATE,QUANTITY,TOTAL_RETAIL_PRICE,COSTPRICE_PER_UNIT,DISCOUNT) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)";    
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Job05_order_fact.class.getClassLoader().getResourceAsStream("bi_project/job05_order_fact_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     36714 characters generated by Talend Open Studio for Data Integration 
 *     on the April 15, 2023 at 12:05:53 AM CET
 ************************************************************************************************/